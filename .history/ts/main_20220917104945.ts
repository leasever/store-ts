...
products.map((product: { _id: number; }, index: any) => {
  document.getElementById("product")!.innerHTML += ` <div class="col" key="${index}" >
      <div class="card">
         <a href="#staticBackdrop" data-bs-toggle="modal"><img src="img/products/scraper.jpg" class="card-img-top" alt="..."></a>
         <div class="card-body">
            <h5 class="card-title">${product._id} - Rascador T-4000</h5>
