          ...
          <div class="col-12">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="${product.image[2]}" class="d-block mx-auto" alt="...">
              </div>
              <div class="carousel-item">
                <img src="${product.image[1]}" class="d-block mx-auto" alt="...">
              </div>
              <div class="carousel-item">
                <img src="${product.image[0]}" class="d-block mx-auto" alt="...">
              </div>
            </div>
            ...
            <div class="col-12  text-center py-3 py-sm-0">
