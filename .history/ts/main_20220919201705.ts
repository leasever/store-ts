          ...
          <div class="col-12">
            ...
            <div class="carousel-inner text-center">
              <div class="carousel-item active">
                <img src="${product.image[2]}" class="d-block w-100 img-thumbnail" alt="${product.name}.jpg">
              </div>
              <div class="carousel-item">
                <img src="${product.image[1]}" class="d-block w-100 img-thumbnail" alt="${product.name}.jpg">
              </div>
              <div class="carousel-item">
                <img src="${product.image[0]}" class="d-block w-100 img-thumbnail" alt="${product.name}.jpg">
              </div>
            </div>
