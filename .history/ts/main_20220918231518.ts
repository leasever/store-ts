...
products.map((product, index) => {
  document.getElementById(
    "product",
  )!.innerHTML += ` <div class="col" key="${index} id="idkey" >
      <div class="card">
         <a href="#staticBackdrop" data-bs-toggle="modal" id="modalProduct"><img src="${product.image[0]}" class="card-img-top" alt="${product.name}"></a>
         <div class="card-body">
            <p class="card-text" id="keyindex" >$ ${product.price}</p>
